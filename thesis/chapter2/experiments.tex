...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{chapter2/Overlay_Tester}
...
\begin{figure}
    \centering
    \begin{tabular}{cc}
       \includegraphics[width=0.49\linewidth]{chapter2/Unbalance_Tester01}  & \includegraphics[width=0.49\linewidth]{chapter2/Unbalance_Tester02} \\
       (a) & (b)
    \end{tabular}
...
\begin{figure}
    \centering
    \begin{tabular}{cc}
        \includegraphics[width=0.50\linewidth]{chapter2/CA} & 
        \includegraphics[width=0.45\linewidth]{chapter2/CA_sample} \\
        (a) & (b)
    \end{tabular}
...
\begin{figure}
    \centering
    \begin{tabular}{cc}
        \includegraphics[width=0.49\linewidth]{chapter2/MainUS} &
        \includegraphics[width=0.49\linewidth]{chapter2/GADM}   \\
        (a) & (b)
    \end{tabular}
...
\begin{figure}
    \centering
    \begin{tabular}{cc}
       \includegraphics[width=0.49\linewidth]{chapter2/MainUS_speedup} & \includegraphics[width=0.49\linewidth]{chapter2/MainUS_scaleup} \\
       (a) & (b)
    \end{tabular}
...
\begin{figure}
    \centering
    \begin{tabular}{cc}
       \includegraphics[width=0.49\linewidth]{chapter2/GADM_speedup} & \includegraphics[width=0.49\linewidth]{chapter2/GADM_scaleup} \\
       (a) & (b)
    \end{tabular}
...
\begin{figure}
    \centering
    \begin{tabular}{cc}
        \includegraphics[width=0.49\linewidth]{chapter2/K_Creation_US.pdf} & \includegraphics[width=0.49\linewidth]{chapter2/K_Creation_GADM.pdf} \\
        (a) & (b) 
    \end{tabular}
...
\begin{figure}
    \centering
    \begin{tabular}{cc}
        \includegraphics[width=0.49\linewidth]{chapter2/K_Space_US.pdf} & \includegraphics[width=0.49\linewidth]{chapter2/K_Space_GADM.pdf} \\
        (a) & (b) 
    \end{tabular}
...
\begin{figure}
    \centering
    \begin{tabular}{cc}
        \includegraphics[width=0.49\linewidth]{chapter2/K_Partitioning_US.pdf} & \includegraphics[width=0.49\linewidth]{chapter2/K_Partitioning_GADM.pdf} \\
        (a) & (b) 
    \end{tabular}
...
\begin{figure}
    \centering
    \begin{tabular}{cc}
        \includegraphics[width=0.49\linewidth]{chapter2/K_Overlay_US.pdf} & \includegraphics[width=0.49\linewidth]{chapter2/K_Overlay_GADM.pdf} \\
        (a) & (b) 
    \end{tabular}
...
\begin{figure}
    \centering
    \begin{tabular}{cc}
        \includegraphics[width=0.49\linewidth]{chapter2/US_speedup.pdf} & \includegraphics[width=0.49\linewidth]{chapter2/US_scaleup.pdf} \\
        (a) & (b) 
    \end{tabular}
...
\begin{figure}
\centering
\includegraphics[width=0.48\linewidth]{chapter2/Experiments/n_records.eps}
\includegraphics[width=0.48\linewidth]{chapter2/Experiments/area.eps}
...
\begin{figure}[tb]
	\centering
	\includegraphics[width=8.8cm]{chapter2/Experiments/speedup.eps}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{chapter2/states.pdf}
