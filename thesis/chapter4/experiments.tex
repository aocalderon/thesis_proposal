...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth] {chapter4/figures/plots/10_cmbc_variants/cmbc.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{chapter4/figures/plots/05_uniform_performance/uniform_performance.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{chapter4/figures/plots/08_sequential_parallel/la25k_e_bfe_psi.pdf}
    \caption{Performance comparing parallel and sequential alternatives in the LA25K dataset.}\label{fig:la25k_e_bfe_psi}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{chapter4/figures/plots/08_sequential_parallel/la25k_e.pdf}
    \caption{Performance of the 4 parallel alternatives in the LA25K dataset.}\label{fig:la25k_e}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{chapter4/figures/plots/08_sequential_parallel/la50k_e.pdf}
