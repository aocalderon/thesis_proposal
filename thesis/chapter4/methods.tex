\section{Background}
Before discussing the details of our contributions, we first provide an overview of the current state-of-the-art. This will help highlighting their challenges 
and limitations in handling large spatio-temporal datasets, as described in the next Section.
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{figures/MF_flowchart}
...
Figure \ref{fig:MF_stages} shows an example of the Phase 1 steps using a sample dataset.
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]
    %{chapter4/figures/cubo2.pdf}
    {chapter4/figures/plots/11_temporal_partitions/TemporalPartitioning.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]
    %{chapter4/figures/cubo.pdf}
    {chapter4/figures/plots/11_temporal_partitions/Cube-based.pdf}
