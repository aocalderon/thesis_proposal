...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{chapter4/figures/merge.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{chapter4/figures/maxdist.pdf}
    \caption{Examples of CPFs that that start or end in the border area of a partition.}\label{fig:maxdist}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{chapter4/figures/cubo2.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{chapter4/figures/cubo.pdf}
