...
\begin{document}
    \begin{tikzpicture}
        \node[stage] (0) at (0,0)
            {Points\\
            \includegraphics[width=\defaultwidth, page=1]{pflock_test}};
        \node[stage] (1) [right = of 0]
            {Finding pairs \\ 
            \includegraphics[width=\defaultwidth, page=2]{pflock_test}};
        \node[stage] (2) [right = of 1] 
            {Computing centers \\ 
            \includegraphics[width=\defaultwidth, page=3]{pflock_test}};
        \node[stage] (3) [right = of 2] 
            {Finding disks \\ 
            \includegraphics[width=\defaultwidth, page=4]{pflock_test}};
        \node[stage] (4) [right = of 3] 
            {Pruning disks \\ 
            \includegraphics[width=\defaultwidth, page=5]{pflock_test}};
