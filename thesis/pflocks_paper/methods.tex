...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{figures/grid_prime}
    \caption{The grid-based structure proposed in \cite{vieira_2009}.}\label{fig:grid}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{figures/MF_stages2/flow}
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{figures/FF_flowchart}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{figures/Temporal/f_stages}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{figures/PartReplication/P123}
...
\begin{figure}
    ...
    {figures/plots/11_temporal_partitions/TemporalPartitioning.pdf}
...
\begin{figure}
    ...
    \includegraphics[width=0.8\linewidth]
    %{figures/cubo.pdf}
    {figures/plots/11_temporal_partitions/Cube-based}
