...
\definecolor{light-gray}{gray}{0.00}
...
\begin{document}
    \begin{tikzpicture}
        ...
        \def\scale{2.00}
        \node[scale=\scale, color=light-gray] at (-0.85, 10.75) {1};
        \node[scale=\scale, color=light-gray] at ( 6.35, 10.75) {2};
        \node[scale=\scale, color=light-gray] at (-3.05, 3.55)   {3};
        \node[scale=\scale, color=light-gray] at ( 1.65, 3.55)   {4};
        \node[scale=\scale, color=light-gray] at (-3.05, -3)       {5};
        \node[scale=\scale, color=light-gray] at ( 1.65, -3)       {6};
        \node[scale=\scale, color=light-gray] at (10.75, -0.75) {7};
    \end{tikzpicture}
\end{document}
